...
import Pembelian from "../containers/global/Pembelian";
      ...
      {isMobile ? (
        <Box>
          ...
          >
            <ButtonCategory
              title={"Produk"}
              icon={<ViewInArIcon sx={{ fontSize: "1.2rem" }} />}
              value={pageM}
              setValue={setPageM}
            />
            <ButtonCategory
              title={"Diminati"}
              icon={<FavoriteBorderIcon sx={{ fontSize: "1.2rem" }} />}
              value={pageM}
              setValue={setPageM}
            />
            <ButtonCategory
              title={"Pembelian"}
              icon={<Shop2Icon sx={{ fontSize: "1.2rem" }} />}
              value={pageM}
              setValue={setPageM}
            />
            <ButtonCategory
              title={"Terjual"}
              icon={<MonetizationOnOutlinedIcon sx={{ fontSize: "1.2rem" }} />}
              value={pageM}
              setValue={setPageM}
            />
          </Box>
        ...
        <>
          <Header active />
          <Box data-testid="daftar-jual-page" mx={28} mt={4}>
